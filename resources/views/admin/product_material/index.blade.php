...
<div class="row">
  <div class="col-12">
      <div class="page-title-box d-sm-flex align-items-center justify-content-between">
          <h4 class="mb-sm-0">Product Material</h4>

          <div class="page-title-right">
            <button type="button" style="float:right" class="btn btn-primary float-right" onclick="window.location.href='{{url('admin/product_material/create')}}'"> <i class="material-icons">Add</i></button>
          </div>
      </div>
  </div>
</div> 
...
var table = $('.data-table').DataTable({
        ...
        ajax: {
            type: 'post',
            url: "{{url('admin/product_material/datatable')}}",
            headers: {
      ...
      .then((willDelete) => {
        if (willDelete) {
          $.ajaxSetup({
            ...
            $.ajax({
              url :"{{url('admin/product_material/delete')}}",
              type : "DELETE",
              data : {id:delete_id},
