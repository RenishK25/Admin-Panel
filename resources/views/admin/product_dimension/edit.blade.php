...
@section('title', 'Update Product Dimension')
...
<div class="row">
  <div class="col-12">
    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
      <h4 class="mb-sm-0">Update Product Dimension</h4>
    </div>
  </div>
</div>
<form>
        ...
        <div class="row">
          <div class="col-sm-12 col-md-4 col-lg-6">
            <div class="form-group">
              ...
              <select class="form-control" name="category_id" id="category_id">
                ...
                {{$product_dimension->category_id == $category->id ? $sel ="selected" : $sel="" }}
          ...
          <div class="col-sm-12 col-md-4 col-lg-6">
            <div class="form-group">
              ...
              <input type="hidden" id="subcategory_value" value="{{$product_dimension->sub_category_id}}">
          ...
          <div class="col-sm-12 col-md-4 col-lg-6">
            <div class="form-group">
              ...
              <input type="hidden" name="id" value="{{$product_dimension->id}}">
              <input type="text" name="name" id="" class="form-control" value="{{ $product_dimension->name }}">
          ...
          <div class="col-sm-12 col-md-4 col-lg-6">
            <div class="form-group">
              ...
              <input type="text" name="value" class="form-control" value="{{ $product_dimension->value }}">
          ...
          <div class="col-lg-12">
            <div class="text-end">
              ...
              <a type="submit" href="{{ url('admin/product_dimension') }}" class="btn btn-danger">Cancel</a>
            </div>
          </div>
        </div>
      </div>
...
<script type="text/javascript">
  $(document).ready(function () {
      ...
      e.preventDefault(); 
        ...
        $.ajax({
          url :"{{url('admin/product_dimension/update')}}",
          type : "post",
          data: form_data,
          dataType: "json",
          processData:false,
          ...
          success : function (data) {
            ...
            function myGreeting() {
            window.location.href="{{url('admin/product_dimension')}}";  
            }
            }
