...
@section('title', 'Add Product Special Feature')
...
<div class="row">
  <div class="col-12">
    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
      <h4 class="mb-sm-0">Add Product Special Feature</h4>
    </div>
  </div>
</div>
<form>
    ...
    <div class="card">
      <div class="card-body">
        <div class="row">
          ...
          <div class="col-sm-12 col-md-4 col-lg-6">
            <div class="form-group">
              <label for="">Product Special Feature</label>
...
<script type="text/javascript">
  $(document).ready(function () {
    ...
    $.ajaxSetup({
      ...
      $.ajax({
        url :"{{url('admin/product_special_feature')}}",
        type : "post",
        data: form_data,
        dataType: "json",
        processData:false,
